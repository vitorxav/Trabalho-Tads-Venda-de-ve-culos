...
namespace LocadoraVeiculosApi.Controllers
{
    ...
    public class AlugueisController : ControllerBase
    {
        ...
        public async Task<IActionResult> Create([FromBody] CreateAluguelDto dto)
        {
            ...
            var ve = await _db.Veiculos.FindAsync(dto.VeiculoId);
            ...
            var funcionario = await _db.Funcionarios.FindAsync(dto.FuncionarioId);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            var ve = await _db.Veiculos.FindAsync(a.VeiculoId);
